...
public class Client {
    ...
    public static void main (String []argumento){
        ...
        Thread jose = new Thread(new Runnable() {
            @Override
            public void run() {
                posibles1.singleton2.Cajero cajeroLaPaz = new Cajero();
        ...
        Thread maria = new Thread(new Runnable() {
            @Override
            public void run() {
                posibles1.singleton2.BancaMovil bancaMovil= new BancaMovil();
        ...
        Thread marcelo = new Thread(new Runnable() {
            @Override
            public void run() {
                posibles1.singleton2.SucursalBanco sucursalBancoCbba= new SucursalBanco();
